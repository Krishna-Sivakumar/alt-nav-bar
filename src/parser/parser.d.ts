...
export type StartRuleNames = "Meal";
export interface ParseOptions<T extends StartRuleNames = "Meal"> {
  /**
...
declare function ParseFunction<Options extends ParseOptions<"Meal">>(
  input: string,
  options?: Options,
): types.Meal;
